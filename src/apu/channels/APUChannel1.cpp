...
void gbtest::APUChannel1::commitNR14()
{
    ...
    if (m_channel1Registers.frequencyHigh.counterConsecutiveSelection && !m_lengthCounter.isEnabled()) {
        // Disabled -> enabled
...
{
    return m_lengthCounter.isChannelDisabled() || m_frequencySweep.isChannelDisabled() || m_dacDisabledChannel;
}
